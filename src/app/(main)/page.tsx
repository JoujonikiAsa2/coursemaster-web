...
import squarePattern from 'src/assets/images/square-pattern.png'

export default function Home() {
  return (
    <div>
      <div className="group relative z-0 bg-secondary overflow-hidden">
        <Banner title='Take Student Experience to the Next Level'
          subtitle='Architect client-centered total linkage for intuitive benefits restore convergence before real-time partnerships.
